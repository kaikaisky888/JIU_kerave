            ...
            ea.table.render({
                ...
                cols: [[
                    ...
                    },
                    {
                        ...
                        templet: function (d) {
                            if (d.is_team === 1) {
                                return '<span class="layui-badge layui-bg-green">团队组</span>';
                            }
                            if (d.is_team === 0) {
                                return '<span class="layui-badge">管理组</span>';
                            } else {
                                return '<span class="layui-badge-rim">其他组</span>';
                            }
                        }
                    },
