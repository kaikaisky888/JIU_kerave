...
(function() {
		...
		return {
			...
			on: function(b, d, h, k, g) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					l.fn = d;
					l.priority = g;
					for (var t = e.length - 1; 0 <= t; t--) if (e[t].priority <= g) return e.splice(t + 1, 0, l), {
						removeListener: v
					};
					e.unshift(l)
				}
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			transformPlainTextToHtml: function(a, b) {
				...
				c = c.replace(/\n/g, "\x3cbr\x3e");
				e || (c = c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + g + "\x3e)"), function(a) {
			...
			keystrokeToArray: function(a, b) {
				...
				e & CKEDITOR.SHIFT && (n.push(g ? "⇧" : a[16]), d.push(a[16]));
			...
			getCsrfToken: function() {
				...
				if (!a || 40 != a.length) {
					...
					else for (var e = 0; 40 > e; e++) a.push(Math.floor(256 * Math.random()));
			...
			convertBytesToBase64: function(a) {
				...
				for (c = 0; c < e; c += 3) {
					...
					d[3] = g[2] & 63;
					for (l = 0; 4 > l; l++) b = l <= n ? b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d[l]) : b + "\x3d"
				}
				return b
			},
			style: {
			...
			object: {
				...
				keys: function(a) {
					...
					if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) for (g = 0; g < c.length; g++) b.call(a, c[g]) && e.push(c[g]);
					return e
				},
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
		...
		getIndex: function(a) {
			function d(a, b) {
				...
				return c && c.type == CKEDITOR.NODE_TEXT ? c.isEmpty() ? d(c, b) : c : null
			}
			var b = this,
				c = -1,
				f;
			...
			do
			if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || !f && !b.isEmpty()) c++, f = b.type == CKEDITOR.NODE_TEXT;
	...
	(function() {
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			moveChildren: function(a, b) {
				...
				if (c != a) {
					var e;
					if (b) for (; e = c.lastChild;) a.insertBefore(c.removeChild(e), a.firstChild);
			...
			mergeSiblings: function() {
				function a(b, c, e) {
					if (c && c.type == CKEDITOR.NODE_ELEMENT) {
						for (var d = []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();) if (d.push(c), c = e ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT) return;
						if (b.isIdentical(c)) {
			...
			removeStyle: function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++) if (e) for (var t = 0; t < e.length; t++) b.push([a, c[d], e[t]].join("-"));
			...
			getDocumentPosition: function(a) {
				...
				} else for (u = this, n = null; u && "body" != u.getName() && "html" != u.getName();) {
				...
				document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || t || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);
				return {
					x: b,
					y: c
				}
			...
			copyAttributes: function(a, b) {
				...
				for (var e = 0; e < c.length; e++) {
					var d = c[e],
						...
						f;
					if (!(t in b)) if ("checked" == t && (f = this.getAttribute(t))) a.setAttribute(t, f);
	...
	(function() {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				...
				this._.guardLTR = function(a, b) {
					return (!b || !K.equals(a)) && (!A || !a.equals(A)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			...
			this.current ? e = this.current[B](!1, m, h) : (a ? e.type == CKEDITOR.NODE_ELEMENT && (e = 0 < x ? e.getChild(x - 1) : !1 === h(e, !0) ? null : e.getPreviousSourceNode(!0, m, h)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, m, h)))), e && !1 === h(e) && (e = null));
			for (; e && !this._.end;) {
				this.current = e;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b = v(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && e(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, f) {
			...
			function g() {
				var b = N - 1,
					c = C && F && !m.equals(B);
				b < O - 1 || b < q - 1 || c ? (c ? a.moveToPosition(B, CKEDITOR.POSITION_BEFORE_START) : q == b + 1 && r ? a.moveToPosition(p[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(p[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = S[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({
					startNode: c
				}))) : a.collapse(!0)
			}
			a.optimizeBookmark();
			...
			if (l && B.type == CKEDITOR.NODE_TEXT && (m.equals(B) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(B))) c.append(a.document.createText(B.substring(K, A)));
				...
				for (var S = m.getParents(), p = B.getParents(), N = n(), O = S.length - 1, q = p.length - 1, E = c, D, ba, J, da = -1, U = N; U <= O; U++) {
					ba = S[U];
					J = ba.getNext();
				...
				E = c;
				for (U = N; U <= q; U++) if (c = p[U], J = c.getPrevious(), c.equals(S[U])) b && (E = E.getChild(0));
				else {
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark: function(a) {
				...
				f || (n = h.clone(), n.setHtml("\x26nbsp;"), a && n.setAttribute("id", g + "E"), k = this.clone(), b(d) && (d = b(d), k.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)), k.collapse(), k.insertNode(n));
				k = this.clone();
			...
			createBookmark2: function() {
				function a(b) {
					...
					n = e;
					var f = d;
					n = n.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == n.getChildCount() ? 0 : n.getChild(f - 1).type == CKEDITOR.NODE_TEXT && n.getChild(f).type == CKEDITOR.NODE_TEXT;
					...
					if (e.type == CKEDITOR.NODE_TEXT) {
						...
						n = f;
						e.isEmpty() ? (f = e.getPrevious(c), n ? (d = n, e = f ? f.getNext() : e.getParent().getFirst()) : (e = e.getParent(), d = f ? f.getIndex(!0) + 1 : 0)) : d += n
					}
					b.container = e;
					b.offset = d
				}
				...
				return function(c) {
					...
					c && (a(f), b(f, this.root), d || (a(n), b(n, this.root)));
					return {
			...
			getBoundaryNodes: function() {
				var a = this.startContainer,
					...
					d = this.endOffset,
					f;
				if (a.type == CKEDITOR.NODE_ELEMENT) if (f = a.getChildCount(), f > c) a = a.getChild(c);
			...
			enlarge: function(a, b) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					...
					for (l = c(l); l || m;) {
						...
						for (; m;) if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious();
						else {
							if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), d.test(M) && (m = null), A = /[\s\ufeff]$/.test(M);
							else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
								M = m.getText();
								if (d.test(M)) m = null;
								else for (var r = m.$.getElementsByTagName("*"), C = 0, F; F = r[C++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
									m = null;
									break
								}
								m && (A = !! M.length)
					...
					l = m = null;
					B = K = !1;
					A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(r)).length ? K = !0 : (K = !A.getLength(), r == A.getLength() ? (m = A.getNext()) || (l = A.getParent()) : h(A, r) && (l = A.getParent())) : (m = A.getChild(r)) || (l = A);
					for (; l || m;) {
						if (l && !m) {
							!B && l.equals(n) && (B = !0);
							if (f ? l.isBlockBoundary() : !g.contains(l)) break;
						...
						for (; m;) {
							...
							if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), h(m, 0) || (m = null), A = /^[\s\ufeff]/.test(M);
								...
								if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
									M = m.getText();
									if (d.test(M)) m = null;
									else for (r = m.$.getElementsByTagName("*"), C = 0; F = r[C++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
										m = null;
										break
									}
									m && (A = !! M.length)
				...
				case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
					...
					l = l.lastBackward();
					w = w || g;
					this.setStartAt(w, !w.is("br") && (!l && this.checkStartOfBlock() || l && w.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
			...
			shrink: function(a, b, c) {
				...
				if (!this.collapsed) {
					...
					h.guard = function(b, c) {
						...
						if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || c && b.equals(K) || !1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
			...
			splitBlock: function(a, b) {
				...
				this.deleteContents();
				f && f.equals(h) && (d ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(h, CKEDITOR.POSITION_AFTER_END), h = null) : c ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (h = this.splitElement(f, b || !1), f.is("ul", "ol") || f.appendBogus()));
				return {
					previousBlock: f,
					nextBlock: h,
					wasStartOfBlock: c,
			...
			_getTableElement: function(a) {
				...
				return d && !this.root.contains(d) ? null : this.getEnclosedNode() ? this.getEnclosedNode().getAscendant(a, !0) : d && c && (d.equals(c) || d.contains(c) || c.contains(d)) ? b.getAscendant(a, !0) : null
			},
			...
			_find: function(a, b) {
				var c = this.getCommonAncestor(),
					...
					f = [],
					h, n, g, k;
				if (c && c.find) for (n = c.find(a), h = 0; h < n.count(); h++) if (c = n.getItem(h), b || !c.isReadOnly()) g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c), g && k && f.push(c);
				return f
			}
		};
	...
	(function() {
		...
		function b(a, c, f, h) {
			...
			if (!h) return 0;
			if ((g = CKEDITOR.filter.instances[h.element.data("cke-filter")]) && !g.check(c)) return b(a, c, f, h.remaining);
	...
	(function() {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (r in T) {
					...
					for (; N = w.pop();) g[N] = g["!" + N], delete g["!" + N];
					h[p] = (E ? !1 : n) || null
				}
			...
			for (d = a.length; c < d; ++c) {
				...
				if (!0 === f.elements || null === f.elements) e[m ? "unshift" : "push"](f);
				else for (B in q = f.elements, delete f.elements, q) if (b[B]) b[B][m ? "unshift" : "push"](f);
				else b[B] = [f]
			}
		}
		function d(a, c, d, e) {
			if (!a.match || a.match(c)) if (e || g(a, c)) if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
				...
				if (a) if (!0 === a) a = !0;
					...
					for (var f = 0, m = c.length, q; f < m; ++f) q = c[f], e[q] || (e[q] = a(q));
					a = !1
				} else a = !1;
				d.allClasses = a
			}
		...
		function H(a) {
			return a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || r.$block[a.name])
		}
		function I(a, b, c) {
			var d = a.name;
			...
			else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !H(a.previous) && (b = y(), b.insertBefore(a)), a.next && !H(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
			else {
				var d = a.children,
					e;
				b: {
		...
		function B(a, b) {
			...
			for (m in e) if (a.styles[m] != e[m]) return !1;
			return !0
		}
		function K(a, b) {
			var c, d;
		...
		CKEDITOR.filter = function(a, b) {
			...
			if (c && !b) {
				...
				!0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(w[c.enterMode] + " " + w[c.shiftEnterMode], "default", 1), this.disallow(c.config.disallowedContent))
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function(a, b, c, d) {
				...
				a.forEach(function(a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						...
						if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (q = z(e, a, f, h), q & 1) p = !0;
				...
				case "it":
					...
					break;
				case "el-up":
					c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g[c.name] || I(c, d, a);
					break;
				case "parent-down":
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						var f = void 0,
							...
							h = void 0;
						c = [];
						for (m = 0; m < b.length; ++m) q = b[m], "string" == typeof q ? (q = q.split(/\s*:\s*/), p = q[0], r = null, h = q[1]) : (p = q.check, r = q.left, h = q.right), f || (f = q, f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] : f.left.getDefinition().element), r instanceof CKEDITOR.style && (r = A(r)), c.push({
							check: p == f ? null : p,
							left: r,
			...
			check: function(a, b, c) {
				...
				if (!1 !== b && (h = this._.transformations[f.name])) {
					for (d = 0; d < h.length; ++d) m(this, f, h[d]);
					u(f)
				}
				z(this, p, r, {
					doFilter: !0,
			...
			transform: function(a, b) {
				if ("string" == typeof b) a.name = b;
					...
					var c = b.getDefinition(),
						...
						e, m, q, p;
					a.name = c.element;
					for (e in f) if ("class" == e) for (c = a.classes.join("|"), q = f[e].split(/\s+/); p = q.pop();) - 1 == c.indexOf(p) && a.classes.push(p);
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, d, b) {
			...
			for (var c = this.loaded, f = this.registered, h = [], k = {}, g = {}, l = 0; l < a.length; l++) {
				var v = a[l];
				if (v) if (c[v] || f[v]) g[v] = this.get(v);
				else {
					...
					a.call(this, b, function(a) {
						...
						for (e in a) {
							...
							if (!d[e]) {
								...
								g.isSupportedEnvironment = g.isSupportedEnvironment ||
								function() {
									return !0
								};
								d[e] = 1
							}
							if (t) for (t.split && (t = t.split(",")), g = 0; g < t.length; g++) h[t[g]] || b.push(t[g])
						}
		...
		function x(a) {
			...
			CKEDITOR.plugins.load(d.split(","), function(b) {
				...
				for (var m in b) {
					...
					k && !a.lang[m] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? B = a.langCode : (B = a.langCode.replace(/-.*/, ""), B = B != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, B) ? B : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), h.langEntries && h.langEntries[B] ? (a.lang[m] = h.langEntries[B], B = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + B + ".js")));
					e.push(B);
					d.push(h)
				}
		...
		function z(a, b) {
			...
			for (var e = new CKEDITOR.dom.documentFragment, f, h, g, k = 0; k < a.length; k++) {
				...
				c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({
					...
					tbody: 1,
					tfoot: 1
				}).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(r) || (h = r, g = r.clone(), f.append(g)), g.append(d(l))) : e.append(l.cloneContents())
			}
		...
		CKEDITOR.htmlParser.prototype = {
			...
			parse: function(b) {
				for (var c, f, h = 0, k; c = this._.htmlPartsRegex.exec(b);) {
					f = c.index;
					if (f > h) if (h = b.substring(h, f), k) k.push(h);
					else this.onText(h);
			...
			G.onTagOpen = function(e, f, h, g) {
				...
				if (a(f)) n.push(f);
					...
					if ("br" == e) L.push(f);
						...
						for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || y.isUnknown || g[e]);) if (y.isOptionalClose) G.onTagClose(h);
						...
						else if (e in CKEDITOR.dtd.$listItem && !z(e, h)) G.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
		...
		a.prototype = {
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					g = k.length,
					l, v, e, x;
				for (x = 0; x < g; x++) if (d && (l = c.type, v = c.name), e = k[x], !(a.nonEditable && !e.options.applyToAll || a.nestedEditable && e.options.excludeNestedEditable)) {
	...
	(function() {
		function a(a, d) {
			...
			function p(a, d) {
				return function(f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (q = !a || !1 !== ("function" == typeof d ? d(f) : d)) g || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? g || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (q = b(f), q = !q || "form" == f.name && "input" == q.name) : q = !1 : q = !1;
						q && f.add(e(a))
					}
				}
			}
			function r(a, b) {
				...
				var c;
				return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(L)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && g && (!b || a.parent.name in w) || !g && ((c = a.previous) && "br" == c.name || !c || h(c))) ? !0 : !1
			}
			var F = {
				elements: {}
			},
		...
		function h(a) {
			return a && (a.type == CKEDITOR.NODE_ELEMENT && a.name in m || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
		}
		function k(a, b) {
		...
		function v(a) {
			return a.replace(r, function(a, b, c) {
		...
		function u(a, b) {
			...
			a = a.replace(f, function(a, b, d) {
				return "\x3c!--" + y + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\x3e"
			});
		...
		var L = /(?:&nbsp;|\xa0)$/,
			...
			m = CKEDITOR.tools.extend({}, H.$blockLimit, H.$block),
			B = {
				elements: {
					input: g,
					textarea: g
		...
		n = function() {
			...
			var c = new RegExp("(" + a("\x3ccke:encoded\x3e") + "(.*?)" + a("\x3c/cke:encoded\x3e") + ")|(" + a("\x3c") + a("/") + "?" + a("cke:encoded\x3e") + ")", "gi"),
	...
	(function() {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				var l, v;
				for (l in k) {
					for (g = k[l];;) if (v = a.onAttributeName(b, l)) if (v != l) delete k[l], l = v;
					else break;
					else {
						delete k[l];
						break
	...
	(function() {
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				insertElementIntoRange: function(a, b) {
					...
					var g, F;
					if (f) for (;
					(g = b.getCommonAncestor(0, 1)) && (F = CKEDITOR.dtd[g.getName()]) && (!F || !F[e]);) if (g.getName() in CKEDITOR.dtd.span) {
					...
					if (!this.is("textarea")) {
						...
						CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
							...
							if (c in C && (b = a.getSelection(), 0 !== b.getRanges().length)) {
								...
								r = b.block,
								d = c.endPath().block,
								r && d && !r.equals(d) ? (a.fire("saveSnapshot"), (f = r.getBogus()) && f.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(r, !1), b.lastElement.mergeSiblings(), e(r, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
								if (!b) return;
		...
		n = function() {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for (var k = F[k.getName()], C = 0, w = c.getChildren(), l = w.count(), n = -1, A = -1, v = 0, T = e.contains(F.$list); C < l; ++C) e = w.getItem(C), a(e) ? (r = e.getName(), T && r in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (g = !! k[r], "br" != r || !e.data("cke-eol") || C && C != l - 1 || (v = (f = C ? h[C - 1].node : w.getItem(C + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && F.$block[f.getName()]), -1 != n || g || (n = C), g || (A = C), h.push({
					isElement: 1,
					isLineBreak: v,
			...
			function r(b, c, d, e) {
				...
				(g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && w[g.getName()] && (h = g.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) && d.contains(h) && e.contains(g) && g.isIdentical(h) && (g.moveChildren(h), g.remove(), r(b, c, d, e))
			}
			function h(b, c) {
				function d(b, c) {
			...
			return function(p, w, O, q) {
				...
				if (!q.checkReadOnly()) {
					...
					var D = w.range,
						...
						J = "html" === w.type,
						x, u, z, y, G, V;
					"text" == w.type && D.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (u = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", D.document), D.insertNode(u), D.setStartAfter(u));
					...
					for (;
					(G = e(D)) && a(G) && G.isBlockBoundary() && z.contains(G);) D.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
					...
					D.moveToBookmark(u);
					E.enterMode === CKEDITOR.ENTER_DIV && "" === E.getData(!0) && ((E = p.getFirst()) && E.remove(), q.setStartAt(p, CKEDITOR.POSITION_AFTER_START), q.collapse(!0));
					if (p = O) {
						p = w.range;
					...
					if (p) {
						...
						for (h(E, P); V < E.length; V++) {
							...
							if (J = D.isLineBreak) J = P, x = q, y = z = void 0, D.hasBlockSibling ? J = 1 : (z = J.startContainer.getAscendant(F.$block, 1)) && z.is({
								div: 1,
								p: 1
							}) ? (y = z.getPosition(x), y == CKEDITOR.POSITION_IDENTICAL || y == CKEDITOR.POSITION_CONTAINS ? J = 0 : (x = J.splitElement(z), J.moveToPosition(x, CKEDITOR.POSITION_AFTER_START), J = 1)) : J = 0;
							if (J) O = 0 < V;
							else {
								J = P.startPath();
	...
	(function() {
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				}, null, null, -1), q.attachListener(q, "mousedown", function() {
					m = 0
				});
				...
				q.attachListener(q, "keydown", G(c), null, null, -1)
			});
		...
		CKEDITOR.dom.selection.prototype = {
			...
			getRanges: function() {
				...
				function() {
					...
					var b = function(b, c) {
							...
							for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, r = -1, n, m; k <= l;) if (r = Math.floor((k + l) / 2), f = e[r], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) l = r - 1;
							else if (0 > n) k = r + 1;
							else return {
								container: d,
								offset: a(f)
			...
			selectRanges: function(a) {
				...
				if (a.length) if (this.isLocked) {
					...
					if (p) this.fake(p);
					else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment() && d(a) && !I && !a[0]._getTableElement({
						table: 1
						...
						if (n) {
							...
							k ? (p = b.document.$.body.createTextRange(), p.moveToElementText(k.$), D.setEndPoint("EndToEnd", p), D.moveEnd("character", -1)) : (q = m.getNext(l), E = m.hasAscendant("pre"), q = !(q && q.getText && q.getText().match(p)) && (E || !m.hasPrevious() || m.getPrevious().is && m.getPrevious().is("br")), E = b.document.createElement("span"), E.setHtml("\x26#65279;"), E.insertBefore(m), q && b.document.createText("﻿").insertBefore(m));
							b.setStartBefore(m);
							m.remove();
							...
							for (D = 0; D < a.length; D++) {
								...
								b.collapsed && CKEDITOR.env.webkit && v(b) && (p = e(this.root), b.insertNode(p), (q = p.getNext()) && !p.getPrevious() && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() ? (x(this.root), b.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
			...
			if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
				...
				for (t.getPosition(x) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
					...
					if (t.equals(x)) t = null, l = !0;
						...
						if (B) if (C = t.getParent(), B = h, H = g, I = k, !C || !(C.getDtd() || CKEDITOR.dtd.span)[H] && !I || B.parentRule && !B.parentRule(C)) l = !0;
						else {
					...
					if (l && u && !u.collapsed) {
						for (var l = L(this, e), w = l.hasAttributes(), y = u.getCommonAncestor(), z = {}, B = {}, C = {}, H = {}, X, W, Y; l && y;) {
							if (y.getName() == g) {
								for (X in h.attributes)!H[X] && (Y = y.getAttribute(W)) && (l.getAttribute(X) == Y ? B[X] = 1 : H[X] = 1);
		...
		function l(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), v(d, e)) : z.call(this, d));
			a.moveToBookmark(b)
		}
		function v(a, b) {
			var c = !b;
	...
	(function() {
		...
		CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
			...
			h && (h = b.clone(), b.shrink(CKEDITOR.SHRINK_TEXT, !1, {
	...
	(function() {
		...
		CKEDITOR.dom.elementPath = function(b, f) {
			...
			if (l.type == CKEDITOR.NODE_ELEMENT) {
				...
				if (l.equals(f)) break;
				if (!k && (v = l.getName(), "true" == l.getAttribute("contenteditable") ? k = l : !h && d[v] && (h = l), a[v])) {
					if (v = !h && "div" == v) {
						a: {
							v = l.getChildren();
...
*/
	...
	(function() {
		...
		function ca(a) {
			function b(b) {
				...
				if (d == CKEDITOR.DIALOG_RESIZE_HEIGHT || d == CKEDITOR.DIALOG_RESIZE_BOTH) l = Math.max(e.minHeight || 0, C - h);
				a.resize(q, l);
		...
		function P(a) {
			...
			f ? f.show() : (d = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", d, "; top: 0px; left: 0px; ", "; width: 100%; height: 100%;", CKEDITOR.env.ie6Compat ? "" : "background-color: " + e, '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat && (e = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + e + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e", d.push('\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'), d.push("void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" + e + "' );document.close();") + "})())"), d.push('" style\x3d"position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity\x3d0)"\x3e\x3c/iframe\x3e')), d.push("\x3c/div\x3e"), f = CKEDITOR.dom.element.createFromHtml(d.join("")), f.setOpacity(void 0 !== c ? c : .5), f.on("keydown", J), f.on("keypress", J), f.on("keyup", J), f.appendTo(CKEDITOR.document.getBody()), D[b] = f);
		...
		CKEDITOR.dialog = function(a, b) {
			...
			function d(b) {
				if (n == CKEDITOR.dialog._.currentTop) {
					...
					else if (-1 != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? A.call(n) : V.call(n), n.selectPage(c), n._.tabs[c][0].focus(), q = 1;
					else if (13 != c && 32 != c || !n._.tabBarMode) if (13 == c) c = b.data.getTarget(), c.is("a", "button", "select", "textarea") || c.is("input") && "button" == c.$.type || ((c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c), q = 1), l = 1;
			...
			this.on("show", function() {
				...
				a.config.dialog_startupFocusTab && b ? (n._.tabBarMode = !0, n._.tabs[n._.currentTabId][0].focus(), n._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = b ? -1 : this._.focusList.length - 1, g.onFocus ? (b = g.onFocus.call(this)) && b.focus() : e(1))
			...
			this.parts.tabs.on("click", function(a) {
				var b = a.data.getTarget();
				b.hasClass("cke_dialog_tab") && (b = b.$.id, this.selectPage(b.substring(4, b.lastIndexOf("_"))), z(this), a.data.preventDefault())
			}, this);
			m = [];
		...
		CKEDITOR.dialog.prototype = {
			...
			show: function() {
				...
				null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, P(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, c = this._.parentDialog.getElement().getFirst(), c.$.style.zIndex -= Math.floor(e / 2), this._.parentDialog.getElement().setStyle("z-index", c.$.style.zIndex), CKEDITOR.dialog._.currentTop = this);
				a.on("keydown", R);
				a.on("keyup", S);
				this._.hasFocus = !1;
				...
				if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
					...
					for (var b in this._.tabs) {
						var c = this._.tabs[b][0],
							e = this._.tabs[b][1];
						b != a && (c.removeClass("cke_dialog_tab_selected"), c.removeAttribute("aria-selected"), e.hide());
			...
			CKEDITOR.dialog.validate = {
				functions: function() {
					...
					return function() {
						...
						for (f = 0; f < e.length; f++) l = d == CKEDITOR.VALIDATE_AND ? l && e[f](b) : l || e[f](b);
						return l ? !0 : c
					}
				},
				regex: function(a, b) {
	...
	(function() {
		...
		CKEDITOR.ui.button.prototype = {
			render: function(a, b) {
				function c() {
					var f = a.mode;
					f && (f = this.modes[f] ? void 0 !== p[f] ? p[f] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, f = a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED : f, this.setState(f), this.refresh && this.refresh())
				}
				var p = null,
					q = CKEDITOR.env,
					...
					if (c.data.space == a.config.toolbarLocation) {
						...
						for (var q = a.toolbox.toolbars, n = D(a), g = n.length, l = 0; l < g; l++) {
							var r, m = 0,
								...
								v = "/" !== p && ("/" === n[l + 1] || l == g - 1),
								x;
							if (p) if (e && (b.push("\x3c/span\x3e"), k = e = 0), "/" === p) b.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');
							else {
								x = p.items || p;
	...
	(function() {
		...
		function x(a) {
				...
				return {
					...
					exec: function(a, b) {
						...
						var d = this,
							...
							g = b.type,
							m = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, a.getCommandKeystroke(this)),
			...
			function l(b, c) {
				...
				if (!d.getById("cke_pastebin")) {
					...
					var h = 0,
						d = d.getWindow();
					CKEDITOR.env.webkit ? (e.append(k), k.addClass("cke_editable"), e.is("body") || (h = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), h = h.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k);
					k.setStyles({
						position: "absolute",
					...
					(h = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute("contenteditable", !0)) : k.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-10000px");
			...
			a.getClipboardData = function(b, c) {
				...
				!1 === t() && (a.removeListener("paste", e), a._.forcePasteDialog && g && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", d), a.on("dialogHide", function(a) {
					a.removeListener();
				...
				e.attachListener(a, "drop", function(e) {
					if (e = e.data) {
						var g = e.dropRange,
							f = e.dragRange,
							l = e.dataTransfer;
						l.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function() {
		...
		CKEDITOR.plugins.add("clipboard", {
			...
			init: function(a) {
				...
				var c, d = B(a);
				a.config.forcePasteAsPlainText ? c = "plain-text" : a.config.pasteFilter ? c = a.config.pasteFilter : !CKEDITOR.env.webkit || "pasteFilter" in a.config || (c = "semantic-content");
		...
		CKEDITOR.plugins.clipboard = {
			...
			fixSplitNodesAfterDrop: function(a, b, c, d) {
				...
				"number" == typeof d && "number" == typeof c && h.type == CKEDITOR.NODE_ELEMENT && (f(a.startContainer, h, c) || f(a.endContainer, h, d))
			},
		...
		CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
			...
			setData: function(a, b) {
				...
				if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a) if ("Text" == n && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired()) this._.fallbackDataTransfer.setData(a, b);
				else try {
					this.$.setData(a, b)
				} catch (c) {}
			},
		...
		CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				onKeyDown: function(a, b) {
					...
					switch (e) {
					case "next":
						for (var d = this._.focusIndex, e = this._.getItems(), c; c = e.getItem(++d);) if (c.getAttribute("_cke_focus") && c.$.offsetWidth) {
							this._.focusIndex = d;
							c.focus(!0);
							break
						}
					...
					case "click":
					case "mouseup":
						return d = this._.focusIndex, (c = 0 <= d && this._.getItems().getItem(d)) && c.fireEventHandler(e, {
	...
	(function() {
		...
		var k = k + (' onmouseover\x3d"CKEDITOR.tools.callFunction({hoverFn},{index});" onmouseout\x3d"CKEDITOR.tools.callFunction({moveOutFn},{index});" onclick\x3d"' + n + 'CKEDITOR.tools.callFunction({clickFn},{index}); return false;"\x3e') + '\x3cspan class\x3d"cke_menubutton_inner"\x3e\x3cspan class\x3d"cke_menubutton_icon"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{iconStyle}"\x3e\x3c/span\x3e\x3c/span\x3e\x3cspan class\x3d"cke_menubutton_label"\x3e{label}\x3c/span\x3e{shortcutHtml}{arrowHtml}\x3c/span\x3e\x3c/a\x3e\x3cspan id\x3d"{id}_description" class\x3d"cke_voice_label" aria-hidden\x3d"false"\x3e{ariaShortcut}\x3c/span\x3e\x3c/span\x3e',
			...
			p = CKEDITOR.addTemplate("menuArrow", '\x3cspan class\x3d"cke_menuarrow"\x3e\x3cspan\x3e{label}\x3c/span\x3e\x3c/span\x3e'),
			...
			proto: {
				render: function(a, b, f) {
					var k = a.id + String(b),
						...
						l = "",
						g = this.editor,
						e, d, m = h == CKEDITOR.TRISTATE_ON ? "on" : h == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off";
					this.role in {
						menuitemcheckbox: 1,
						menuitemradio: 1
				...
				if (b = b || y(a)) {
					...
					if (c && f && k) {
						...
						if (c.is("li") || c.getParent().is("li")) {
							...
							if (d.is("li")) b || h ? (b && h && f.remove(), c[h ? "insertAfter" : "insertBefore"](d)) : c.breakParent(d);
							else {
								if (a) if (p.block.is("li") ? (d = g.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), r && d.setAttribute("dir", t), q && d.setAttribute("style", q), k && d.setAttribute("class", k), c.moveChildren(d)) : d = p.block, b || h) d[b ? "insertBefore" : "insertAfter"](f);
								else c.breakParent(f), d.insertAfter(f);
								else if (c.appendBogus(!0), b || h) for (; g = c[b ? "getFirst" : "getLast"]();) g[b ? "insertBefore" : "insertAfter"](f);
								else for (c.breakParent(f); g = c.getLast();) g.insertAfter(f);
								c.remove()
							}
							l.selectBookmarks(m);
							return
					...
					if (q = b.splitBlock(m)) {
						...
						f = q.wasStartOfBlock;
						k = q.wasEndOfBlock;
						c ? (h = c.getParent(), h.is("li") && (c.breakParent(h), c.move(c.getNext(), 1))) : a && (h = a.getParent()) && h.is("li") && (a.breakParent(h), h = a.getNext(), b.moveToElementEditStart(h), a.move(a.getPrevious()));
						if (f || k) if (n(e)) b.moveToElementEditStart(b.getTouchedStartNode());
						else {
							if (a) {
			...
			enterBr: function(a, e, b, l) {
				if (b = b || y(a)) {
					var n = b.document,
						...
						k = f.block,
						p = k && f.block.getName();
					l || "li" != p ? (!l && g && w.test(p) ? (g = k.getDirection()) ? (n = n.createElement("div"), n.setAttribute("dir", g), n.insertAfter(k), b.setStart(n, 0)) : (n.createElement("br").insertAfter(k), CKEDITOR.env.gecko && n.createText("").insertAfter(k), b.setStartAt(k.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == p && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? n.createText("\r") : n.createElement("br"), b.deleteContents(), b.insertNode(a), CKEDITOR.env.needsBrFiller ? (n.createText("﻿").insertAfter(a), g && (k || f.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", b.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : b.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), b.collapse(!0), b.select(), b.scrollIntoView()) : r(a, e, b, l)
				}
			}
		};
	...
	(function() {
		...
		l.prototype = {
			...
			attachRequestListeners: function() {
				...
				d.onload = function() {
					b.update();
					if ("abort" != b.status) if (b.uploaded = b.uploadTotal, 200 > d.status || 299 < d.status) b.message = b.lang.filetools["httpError" + d.status], b.message || (b.message = b.lang.filetools.httpError.replace("%1", d.status)), b.changeStatus("error");
					else {
						for (var a = {
							fileLoader: b
	...
	(function() {
		...
		function l(a, b, d, c) {
			if (c && c.length) for (var e, g = c.length; g--;) if (e = c[g], "hbox" != e.type && "vbox" != e.type && "fieldset" != e.type || l(a, b, d, e.children), e.filebrowser) if ("string" == typeof e.filebrowser && (e.filebrowser = {
		...
		function m(a, b) {
			...
			if ("function" != typeof b || !1 !== b.call(this._.filebrowserSe)) if (!e || !1 !== e.call(this._.filebrowserSe, a, b)) if ("string" == typeof b && b && alert(b), a && (c = this._.filebrowserSe, d = c.getDialog(), c = c.filebrowser.target || null)) if (c = c.split(":"), e = d.getContentElement(c[0], c[1])) e.setValue(a), d.selectPage(c[0])
		}
	...
	(function() {
		...
		CKEDITOR.env.ie && (g = 'return false;" onmouseup\x3d"CKEDITOR.tools.getMouseButton(event)\x3d\x3dCKEDITOR.MOUSE_BUTTON_LEFT\x26\x26');
		var d = d + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event,this);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" onclick\x3d"' + g + 'CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan id\x3d"{id}_text" class\x3d"cke_combo_text cke_combo_inlinelabel"\x3e{label}\x3c/span\x3e\x3cspan class\x3d"cke_combo_open"\x3e\x3cspan class\x3d"cke_combo_arrow"\x3e' + (CKEDITOR.env.hc ? "\x26#9660;" : CKEDITOR.env.air ? "\x26nbsp;" : "") + "\x3c/span\x3e\x3c/span\x3e\x3c/a\x3e\x3c/span\x3e"),
			m = CKEDITOR.addTemplate("combo", d);
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				render: function(a, b) {
					...
					var d = CKEDITOR.env,
						f, e, c = "cke_" + this.id,
						l = CKEDITOR.tools.addFunction(function(b) {
							e && (a.unlockSelection(1), e = 0);
							f.execute(b)
						}, this),
						h = this;
					f = {
						...
						combo: this,
						focus: function() {
							CKEDITOR.document.getById(c).getChild(1).focus()
						},
						execute: function(b) {
							var c = h._;
							if (c.state != CKEDITOR.TRISTATE_DISABLED) if (h.createPanel(a), c.on) c.panel.hide();
							else {
								h.commit();
								var d = h.getValue();
								d ? c.list.mark(d) : c.list.unmarkAll();
								c.panel.showBlock(h.id, new CKEDITOR.dom.element(b), 4)
							}
						},
						clickFn: l
					};
					this._.listeners.push(a.on("activeFilterChange", k, this));
					this._.listeners.push(a.on("mode", k, this));
					this._.listeners.push(a.on("selectionChange", k, this));
					!this.readOnly && this._.listeners.push(a.on("readOnly", k, this));
					var g = CKEDITOR.tools.addFunction(function(a, b) {
						...
						case 32:
						case 40:
							CKEDITOR.tools.callFunction(l, b);
							break;
						default:
							f.onkey(f, c)
						}
				...
				createPanel: function(a) {
					if (!this._.panel) {
						var b = this._.panelDefinition,
							...
							e = new CKEDITOR.ui.floatPanel(a, g, b),
							b = e.addListBlock(this.id, d),
							c = this;
						e.onShow = function() {
	...
	(function() {
		function m(a) {
			...
			if (b && !b.isDetached()) {
				...
				CKEDITOR.env.ie && !CKEDITOR.env.edge && b.enterMode != CKEDITOR.ENTER_P ? e("p") : CKEDITOR.env.edge && 15 > CKEDITOR.env.version && b.enterMode != CKEDITOR.ENTER_DIV && e("div");
			...
			proto: {
				setData: function(a, e) {
					...
					if (e) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady");
						...
						d ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), h && (a = a.replace(/<head[^>]*?>/, "$\x26" + h)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = f + a) : a = c.docType + '\x3chtml dir\x3d"' + c.contentsLangDirection + '" lang\x3d"' + (c.contentsLanguage || b.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + h + g + "\x3c/head\x3e\x3cbody" + (c.bodyId ? ' id\x3d"' + c.bodyId + '"' : "") + (c.bodyClass ? ' class\x3d"' + c.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
	...
	(function() {
		function w(f) {
			function g(b) {
				...
				for (var e = k.isIndent ? 1 : -1, a = d[0], d = d[d.length - 1], h = CKEDITOR.plugins.list.listToArray(b, q), m = h[d.getCustomData("listarray_index")].indent, a = a.getCustomData("listarray_index"); a <= d.getCustomData("listarray_index"); a++) if (h[a].indent += e, 0 < e) {
				...
				if (!k.isIndent) {
					var t;
					if ((t = b.getParent()) && t.is("li")) for (var d = e.listNode.getChildren(), r = [], l, a = d.count() - 1; 0 <= a; a--)(l = d.getItem(a)) && l.is && l.is("li") && r.push(l)
				}
	...
	(function() {
		...
		CKEDITOR.plugins.link = {
			getSelectedLink: function(c, b) {
				...
				for (e = 0; e < f.length; e++) if (g = a.getRanges()[e], g.shrink(CKEDITOR.SHRINK_ELEMENT, !0, {
					skipBogus: !0
			...
			parseLinkAttributes: function(c, b) {
				...
				if (!d.type) if (f = a.match(x)) d.type = "anchor", d.anchor = {}, d.anchor.name = d.anchor.id = f[1];
			...
			getLinkAttributes: function(c, b) {
				...
				case "email":
					...
					case "encode":
						...
						break;
					default:
						a = f.split("@", 2), d.name = a[0], d.domain = a[1], a = ["javascript:", r(c, d)]
					}
			...
			exec: function(c) {
				if (CKEDITOR.env.ie) {
					var b = c.getSelection().getRanges()[0],
						...
						e;
					b.collapsed && a && (e = b.createBookmark(), b.selectNodeContents(a), b.select())
				}
	...
	(function() {
		function K(a, l, d, f) {
			...
			for (var h = l.root.getDocument(), k, c, b = 0; b < g.length; b++) {
				...
				k.is(this.type) || (c = h.createElement(this.type), k.copyAttributes(c, {
					start: 1,
					type: 1
				}), c.removeStyle("list-style-type"), e[p].parent = c)
			}
		...
		function L(a, l, d) {
			...
			if (!(1 > g.length)) {
				...
				for (d.push(b); g.length;) d = g.shift(), a = e.createElement("li"), c = d, c.is("pre") || M.test(c.getName()) || "false" == c.getAttribute("contenteditable") ? d.appendTo(a) : (d.copyAttributes(a), h && d.getDirection() && (a.removeStyle("direction"), a.removeAttribute("dir")), d.moveChildren(a), d.remove()), a.appendTo(b);
		...
		function G(a) {
			function l(d) {
				...
				f && f.type == CKEDITOR.NODE_ELEMENT && f.is(a.getName()) && (F(a, f, null, !d), a.remove(), a = f)
			}
			l();
			l(1)
		}
		...
		function D(a, l, d) {
			...
			for (; d.checkStartOfBlock() && d.checkEndOfBlock();) {
				...
				f = h.block;
				if (!f) break;
				f.is("li") && (g = f.getParent(), f.equals(g.getLast(t)) && f.equals(g.getFirst(t)) && (f = g));
		...
		CKEDITOR.plugins.list = {
			...
			arrayToList: function(a, l, d, f, e) {
				...
				for (var g, b = a[d].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(b), k = null, c = d, p = Math.max(a[d].indent, 0), m = null, n, r, y = f == CKEDITOR.ENTER_P ? "p" : "div";;) {
					var q = a[c];
					g = q.grandparent;
					...
					if (q.indent == p) {
						...
						c++
					} else if (q.indent == Math.max(p, 0) + 1) q = a[c - 1].element.getDirection(1), c = CKEDITOR.plugins.list.arrayToList(a, null, c, f, q != n ? n : null), !m.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= b.$.documentMode && m.append(b.createText(" ")), m.append(c.listNode), c = c.nextIndex;
						...
						var k = g.getDirection(1) != n,
							...
							x;
						for (g = 0; g < z; g++) if (v = q.contents[g], I(v) && 1 < z) J ? x = v.clone(1, 1) : m.append(v.clone(1, 1));
						...
						} else J ? (r || (r = b.createElement(y), m.append(r), k && r.setAttribute("dir", n)), E && r.setAttribute("style", E), B && r.setAttribute("class", B), x && (r.append(x), x = null), r.append(v.clone(1, 1))) : m.append(v.clone(1, 1));
				...
				if (l) for (a = h.getFirst(); a;) {
					if (a.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(l, a), a.getName() in CKEDITOR.dtd.$listItem && (d = a, b = e = f = void 0, f = d.getDirection()))) {
		...
		C.prototype = {
			exec: function(a) {
				...
				if (this.state == CKEDITOR.TRISTATE_OFF) {
					...
					} else e.enterMode == CKEDITOR.ENTER_BR ? h.appendBogus() : b[0].fixBlock(1, e.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), g.selectRanges(b)
				}
				...
				(k = b.getNextRange()) && ++p;) {
					...
					k = k.createIterator();
					for (k.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; m = k.getNextParagraph();) if (!m.getCustomData("list_block") && !f(m)) {
						...
						r || (r = y, r.getCustomData("list_group_object_" + p) ? r.getCustomData("list_group_object_" + p).contents.push(m) : (n = {
							root: r,
							contents: [m]
					...
					if ("wysiwyg" == a.mode && d in {
						...
						if (e && e.collapsed) {
							...
							if (b) {
								...
								if (k.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), b = (h = f.getLast(t)) && H(h) ? h : f, g = 0, (c = k.next()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in u && c.equals(h) ? (g = 1, c = k.next()) : e.checkBoundaryOfElement(b, CKEDITOR.END) && (g = 2), g && c) {
									e = e.clone();
	...
	(function() {
		...
		function l(a, b) {
			...
			if (0 < c.length) for (e = 0; e < c.length; e++)(function(a) {
			...
			getConfigValue: function(a, b) {
				if (a && a.config) {
					var d = CKEDITOR.tools,
						c = a.config,
						e = d.object.keys(c),
						f = ["pasteTools_" + b, "pasteFromWord_" + b, "pasteFromWord" + d.capitalize(b, !0)],
			...
			init: function(a) {
				function g(a) {
					var b = CKEDITOR.plugins.pastefromword && CKEDITOR.plugins.pastefromword.images,
						c, d = [];
					if (b && a.editor.filter.check("img[src]") && (c = b.extractTagsFromHtml(a.data.dataValue), 0 !== c.length && (b = b.extractFromRtf(a.data.dataTransfer["text/rtf"]), 0 !== b.length && (CKEDITOR.tools.array.forEach(b, function(b) {
						d.push(b.type ? "data:" + b.type + ";base64," + CKEDITOR.tools.convertBytesToBase64(CKEDITOR.tools.convertHexStringToBytes(b.hex)) : null)
					}, this), c.length === d.length)))) for (b = 0; b < c.length; b++) 0 === c[b].indexOf("file://") && d[b] && (a.data.dataValue = a.data.dataValue.replace(c[b], d[b]))
				}
				var e = 0,
					f = CKEDITOR.plugins.getPath("pastetools"),
					h = this.path,
					k = void 0 === a.config.pasteFromWord_inlineImages ? !0 : a.config.pasteFromWord_inlineImages,
					f = [CKEDITOR.getUrl(f + "filter/common.js"), CKEDITOR.getUrl(h + "filter/default.js")];
				...
				a.pasteTools.register({
					filters: a.config.pasteFromWordCleanupFile ? [a.config.pasteFromWordCleanupFile] : f,
					canHandle: function(a) {
						...
						var b = CKEDITOR.plugins.pastetools.getContentGeneratorName(a),
							c = /(class="?Mso|style=["'][^"]*?\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/,
							b = b ? "microsoft" === b : c.test(a);
						return a && (e || b)
					},
					handle: function(f, b) {
						var c = f.data,
							d = CKEDITOR.plugins.pastetools.getClipboardData(c, "text/html"),
							g = CKEDITOR.plugins.pastetools.getClipboardData(c, "text/rtf"),
							d = {
								dataValue: d,
								dataTransfer: {
									"text/rtf": g
	...
	CKEDITOR.plugins.removeformat = {
			...
			removeformat: {
				exec: function(a) {
					for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), d = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, p = a.getSelection().getRanges().createIterator(), q = function(a) {
						...
						m(b);
						if (l) for (m(l), b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(l);) if (b.isReadOnly()) {
							if (b.getPosition(l) & CKEDITOR.POSITION_CONTAINS) break;
							b = b.getNext(q)
						} else m = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == b.getName() && b.data("cke-realelement") || b.hasAttribute("data-cke-bookmark") || !f(a, b) || (h.test(b.getName()) ? b.remove(1) : (b.removeAttributes(d), a.fire("removeFormatCleanup", b))), b = m;
						e.startNode.remove();
		...
		filter: function(a, h) {
			for (var d = a._.removeFormatFilters || [], f = 0; f < d.length; f++) if (!1 === d[f](h)) return !1;
			return !0
		}
	};
	...
	CKEDITOR.plugins.add("scayt", {
		...
		parseConfig: function(a) {
			...
			a.config.scayt_disableCache && "boolean" !== typeof a.config.scayt_disableCache && (a.config.scayt_disableCache = !1);
			if (void 0 === a.config.scayt_cacheSize || "number" != typeof a.config.scayt_cacheSize || 1 > a.config.scayt_cacheSize) a.config.scayt_cacheSize = 4E3
		},
		addRule: function(a) {
			var c = CKEDITOR.plugins.scayt,
				d = a.dataProcessor,
			...
			this.loadScaytLibrary(a, function(a) {
				...
				if (f) {
					f = {
						...
						disableCache: a.config.scayt_disableCache,
						cacheSize: a.config.scayt_cacheSize,
		...
		init: function(a) {
			...
			if (!a.blockless) {
				...
				a.addCommand("table", new CKEDITOR.dialogCommand("table", {
					context: "table",
					allowedContent: "table{width,height,border-collapse}[align,border,cellpadding,cellspacing,summary];caption tbody thead tfoot;th td tr[scope];td{border*,background-color,vertical-align,width,height}[colspan,rowspan];" + (a.plugins.dialogadvtab ? "table" + a.plugins.dialogadvtab.allowedContent() : ""),
	...
	(function() {
		...
		function r(d, f) {
			for (var b = D(d) ? d : q(d), c = b[0], e = c.getAscendant("table"), c = c.getDocument(), h = b[0].getParent(), a = h.$.rowIndex, b = b[b.length - 1], k = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(e.$.rows[k]), a = f ? a : k, h = f ? h : b, b = CKEDITOR.tools.buildTableMap(e), e = b[a], a = f ? b[a - 1] : b[a + 1], b = b[0].length, c = c.createElement("tr"), k = 0; e[k] && k < b; k++) {
				var g;
		...
		function u(d, f) {
			for (var b = D(d) ? d : q(d), c = b[0].getAscendant("table"), e = w(b, 1), b = w(b), h = f ? e : b, a = CKEDITOR.tools.buildTableMap(c), c = [], e = [], b = [], k = a.length, g = 0; g < k; g++) {
		...
		function y(d) {
			...
			d.reset();
			var l = 0;
			for (d = a.length; l < d; l++) for (var n = 0, p = a[l].length; n < p; n++) void 0 === k && a[l][n] == e.$ && (k = n), a[l][n] == h.$ && (g = n);
			for (l = k; l <= g; l++) for (n = 0; n < a.length; n++) h = a[n], e = new CKEDITOR.dom.element(c.$.rows[n]), h = new CKEDITOR.dom.element(h[l]), h.$ && (1 == h.$.colSpan ? h.remove() : --h.$.colSpan, n += h.$.rowSpan - 1, e.$.cells.length || m.push(e));
		...
		function z(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				...
				a: {
					...
					for (h = 0; k = b[h++];) if ((g = k.getPrevious()) && !g.getCustomData("delete_cell") || (g = k.getNext()) && !g.getCustomData("delete_cell")) {
		...
		function C(d, f) {
			...
			if (1 < g) {
				m = Math.ceil(g / 2);
				for (var g = Math.floor(g / 2), c = a + m, e = new CKEDITOR.dom.element(e.$.rows[c]), h = A(h, c), l, c = b.clone(), a = 0; a < h.length; a++) if (l = h[a], l.parentNode == e.$ && a > k) {
					c.insertBefore(new CKEDITOR.dom.element(l));
					break
				} else l = null;
				l || e.append(c)
			} else for (g = m = 1, e = c.clone(), e.insertAfter(c), e.append(c = b.clone()), l = A(h, a), k = 0; k < l.length; k++) l[k].rowSpan++;
			c.appendBogus();
			b.$.rowSpan = m;
			c.$.rowSpan = g;
	...
	(function() {
		...
		function z(a, b) {
			...
			for (c = 0; c < e[k].length; c++) if (b.$ === e[k][c]) {
				p = c;
				break
			}
			l > p && (c = l, l = p, p = c);
			for (c = g; c <= k; c++) for (g = l; g <= p; g++) d = new CKEDITOR.dom.element(e[c][g]), d.$ && !d.getCustomData("selected_cell") && (h.push(d), CKEDITOR.dom.element.setMarker(f, d, "selected_cell", !0));
		...
		function L(a) {
			var b = (a = a.editor || a.sender.editor) && a.getSelection(),
				...
				e;
			if (b && (A(a), b.isInTable() && b.isFake)) if (d) a.getSelection().reset();
		...
		function w(a) {
			...
			if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				...
				h && h.hasAttribute("data-cke-tableselection-ignored") || (d(a, g, k, h) && A(e, !0), !m.active && "mousedown" === a.name && CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && h && (m = {
					active: !0
		...
		function N(a, b) {
			...
			g.getById("cke_table_copybin") || (p = g.createElement(l), x = g.createElement(l), x.setAttributes({
				...
				height: "1px",
				overflow: "hidden"
			}), p.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), x.append(p), a.editable().append(x), m = a.on("selectionChange", c, null, null, 0), f && (n = h.scrollTop), k.selectNodeContents(p), k.select(), f && (h.scrollTop = n), setTimeout(function() {
				x.remove();
				d.selectBookmarks(e);
				m.removeListener();
				a.fire("unlockSnapshot");
		...
		var H = {
			onPaste: function(a) {
				...
				(function(a, b, d, c) {
					...
					if (b = !c)(b = a[0]) ? (b = b.clone(), b.enlarge(CKEDITOR.ENLARGE_ELEMENT), b = (b = b.getEnclosedNode()) && b.is && b.is(CKEDITOR.dtd.$tableContent)) : b = void 0, b = !b;
					return b ? !1 : !0
					...
					t(d, a)
				}), h ? (a.stop(), k ? (f.insertRow(1, 1 === k, !0), e.selectElement(f.rows.first)) : (f.emptyCells(), t(d, f.cells.all)), a = f.getTableMap(), l = CKEDITOR.tools.buildTableMap(h), f.insertRow(l.length - a.length), f.insertColumn(c(l) - c(a)), a = f.getTableMap(), this.pasteTable(f, a, l), d.fire("saveSnapshot"), setTimeout(function() {
					d.fire("afterPaste")
			...
			pasteTable: function(a, b, c) {
				var d, e = C(a.cells.first),
					...
					k = {},
					h, f, l, p;
				for (l = 0; l < c.length; l++) for (h = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++) if (f = new CKEDITOR.dom.element(c[l][p]), d = b[l] && b[l][p] ? new CKEDITOR.dom.element(b[l][p]) : null, f && !f.getCustomData("processed")) {
			...
			pixelSearch: function() {
				function a(a, c, e, g, f) {
					for (var h = 0, k; f(e);) {
						e += g;
						if (25 == ++h) break;
						if (k = this.doc.$.elementFromPoint(c, e)) if (k == a) h = 0;
						else if (d(a, k) && (h = 0, l(k = new CKEDITOR.dom.element(k)))) return k
					}
				}
				var d = CKEDITOR.env.ie || CKEDITOR.env.webkit ?
				function(a, c) {
					return a.contains(c)
				} : function(a, c) {
	...
	(function() {
		...
		function W(a) {
			...
			b.on("drop", function(c) {
				...
				else if (h == CKEDITOR.DATA_TRANSFER_INTERNAL) if (!f && 0 < b.widgets.selected.length) c.data.dataTransfer.setData("text/html", F(b));
				else if (f = a.instances[f]) e.setStartBefore(f.wrapper), e.setEndAfter(f.wrapper), c.data.dragRange = e, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount, delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount, c.data.dataTransfer.setData("text/html", f.getClipboardHtml()), b.widgets.destroy(f, !0)
			});
		...
		function ia(a) {
			var b = a.editables,
				c, d;
			a.editables = {};
			if (a.editables) for (c in b) d = b[c], a.initEditable(c, "string" == typeof d ? {
				selector: d
			} : d)
		}
		function O(a) {
			if (!0 === a.mask) ma(a);
				...
				for (var h in a.editables) a.editables[h].on("focus", function() {
			...
			function c(a) {
				...
				function c(a) {
					function b(a, c) {
						...
						for (var f in a) if (("object" !== typeof a[f] || "object" !== typeof c[f] || !b(a[f], c[f])) && a[f] !== c[f]) return !1;
						return !0
					}
					return function(c) {
			...
			CKEDITOR.style.addCustomHandler({
				...
				removeStylesFromSameGroup: function(a) {
					...
					if (this.checkApplicable(g, a)) for (var k = 0, n = this.group.length; k < n; k++) {
						...
						for (var m = 0; m < c.length; m++) c[m] !== this && c[m].checkActive(g, a) && (a.widgets.focused.removeStyle(c[m]), b = !0)
					}
					return b
				},
				checkActive: function(a, b) {
		...
		g.prototype = {
			...
			initEditable: function(a, b) {
				...
				}), c.filter && c.data("cke-filter", c.filter.id), c.addClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), b.pathName && c.data("cke-display-name", b.pathName), this.editor.focusManager.add(c), c.on("focus", M, this), CKEDITOR.env.ie && c.on("blur", L, this), c._.initialSetData = !0, c.setData(c.getHtml()), !0) : !1
			},
		...
		var u = CKEDITOR.tools.createClass({
			...
			_: {
				createCopyBin: function(a) {
					...
					c.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px");
					this.editor = a;
					this.copyBin = c;
					this.container = b
				},
