...
// 发一点感慨，layui写的一点不人性化，懒的自己写，结果却坑了一地。作者也算是闲着做了一件好事，让懒人拿来就用；只是真的用起来，问题多多
;
	...
	o.prototype.load = function(e) {
		...
		if (f[0]) {
			var m = l(e.scrollElem || document),
				...
				cos = !("colSpan" in e) || e.colSpan,
				v = e.end || flow_nodata,
				y = e.scrollElem && e.scrollElem !== document,
				d = "<cite>" + flow_load_more + "</cite>";
                if(cos && cos > 0){
                    var h = l('<tr><td colspan="'+cos+'"><div class="layui-flow-more"><a href="javascript:;">' + d + "</a></div></td></tr>");
                }else{
